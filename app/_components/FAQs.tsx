...
const FAQs = () => {
    ...
    return (
        <div className='my-10'>
            <div className="bg-[url('/Images/Divs/BackgroundImage.svg')] bg-cover  bg-center bg-no-repeat ">
                    ...
                    <div className="col-span-6 px-10 py-5">
                        <div className="bg-white p-4 shadow rounded-2xl">
                            <div className="flex justify-center gap-4 bg-white p-4 shadow rounded-2xl">
                                <h1 className='text-4xl font-bold text-[#3F5C7C] '>Frequently Asked Questions</h1>
                                    ...
                                    <div className="">
                                        <div className="px-4 py-8 shadow rounded-2xl ">
                                            ...
                                            {selected === question && (
                                                ...
                                                <div className="mt-5">
                                                    <h2 className='text-2xl text-gray-500'>{question.answer}</h2>
                                                </div>
                                            )}
                                        </div>
                                    </div>
